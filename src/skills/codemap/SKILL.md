...
```bash
node <path-to-opencode-config>/skills/codemap/scripts/codemap.mjs init \
  --root ./ \
  --include "src/**/*.ts" \
...
```bash
node <path-to-opencode-config>/skills/codemap/scripts/codemap.mjs changes \
  --root ./
```
...
```bash
node <path-to-opencode-config>/skills/codemap/scripts/codemap.mjs update \
  --root ./
```
